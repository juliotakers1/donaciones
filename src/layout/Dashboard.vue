<template>
    ...
    <div>
      ...
      <!-- <h2 class="text-center mb-3">Sistema de Administración</h2> -->
        <div class="container form-container d-flex mx-auto mt-3 row">    
          <router-link class=" col-lg-4 col-md-4 col-sm-12" to="/usuarios"  style="text-decoration: none;">
    ...
    <!--          <i class="fas fa-user-injured mb-3" style="font-size:100px; color: white;"></i>-->
          ...
          <router-link class=" col-lg-4 col-md-4 col-sm-12" to="/donacion-menu"  style="text-decoration: none;">
            <button type="button" class="btn btn-lg btn-block  mb-3 " style="font-size:25px; display: block; width: 100%; height: 290px; background-color: #15BE4C; color: black; border-radius: 10px;">
          ...
          <router-link class=" col-lg-4 col-md-4 col-sm-12" to="/beneficiarios"  style="text-decoration: none;" >
            <!-- v-if="user !== 'USER'" -->
            <button type="button" class="btn btn-lg btn-block  mb-3" style="font-size:25px; display: block; width:100%; height: 290px; background-color: #15BE4C; color: black; border-radius: 10px;">
              <i class="fas fa-users mb-3" style="font-size:100px; color: white;"></i>
    <!--          <i class="fas fa-passport mb-3" style="font-size:100px; color: white;"></i>-->
              <br>
              <strong>Beneficiarios</strong>
            </button>
          </router-link>
    
          <router-link class=" col-lg-4 col-md-4 col-sm-12" to="/gastos"  style="text-decoration: none;" >
            <button type="button" class="btn btn-lg btn-block  mb-3 " style="font-size:25px; display: block; width: 100%; height: 290px; background-color: #15BE4C; color: black; border-radius: 10px;">
              <i class="fas fa-money-bill-wave mb-3" style="font-size:100px; color: white;"></i>
