    ...
    <div>
        ...
        <div class="container card shadow-lg" style="margin-top: 50px;">
            <div class="form-container d-flex justify-content-left p-3">
                <router-link class="btn btn-add me-2 fw-bold text-white shadow-lg" to="/beneficiario">Agregar Nuevo</router-link>
              </div>
                  ...
                  <tbody >
                      ...
                      <td>
                        <table class="table table-striped text-center my-3" style="border-radius: 5px;">
                            ...
                            <tbody >
                                <tr class="" v-for="item in item.gasto" :key="item._id">
                                  <!-- <td>{{ item._id }}</td> -->
                                 <td>{{ item.fecha }}</td>
                                 <td>{{ item.descripcion }}</td>
                                 <td>{{ item.total }}</td>
...
export default {
    ...
    setup(){
        ...
        const beneficiarios = computed(() => store.state.beneficiarios)
